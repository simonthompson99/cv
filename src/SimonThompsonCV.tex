...
I am a certified \textbf{AWS Cloud Practitioner} and use various AWS services, provisioned using \textbf{Terraform} and \textbf{Gitlab CI}, to create data processing pipelines.
