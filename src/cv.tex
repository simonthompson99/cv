...
\begin{document}
\makeheading{Dr.~Simon~R.~Thompson, {\em Clinical Data Scientist}
...
I currently create and maintain data products which improve and disseminate the clinical data held by Genomics England, that inputs to a world-leading interpretation pipeline bringing the benefits of precision medicine to NHS patients.
...
\textbf{Clinical Data Scientist} \hfill {October 2017 to present}
...
I routinely use \textbf{git} and \textbf{GitHub} for version control, and have created custom \textbf{Docker} images to run \textbf{GitLab} jobs.
